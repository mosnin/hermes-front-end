  ...
  return (
    <div className="p-8">
      ...
      {usage?.autonomyPaused && (
        <Reveal className="mb-4 rounded-lg border border-red-200 bg-red-50 p-3 text-sm text-red-700">
          ...
          <Card className="mb-6">
            ...
            <Stagger className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
              {Object.entries(metrics.slo).map(([key, s]) => (
                <StaggerItem key={key} className="rounded-lg border border-border p-3">
      ...
      {forecast && (
        <Reveal>
          <Card className={`mb-6 ${forecast.anomaly || forecast.overBudget ? "border-amber-300" : ""}`}>
            <div className="mb-3 flex items-center justify-between">
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              ...
              <div>
                ...
                <p className={`text-2xl font-semibold ${forecast.overBudget ? "text-red-600" : ""}`}>
              ...
              <div>
                ...
                <p className={`text-2xl font-semibold ${forecast.anomaly ? "text-amber-700" : ""}`}>
